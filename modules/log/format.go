...
//LocationTrims được cắt tỉa để hiển thị tránh các dòng nhật ký khó sử dụng.
var locationTrims = []string{
	"github.com/ipwf/go-ipwf/",
}

// PrintOrigins sets or unsets log location (file:line) printing for terminal
// Đặt hoặc không đặt vị trí nhật ký (tệp: dòng) in cho thiết bị đầu cuối
// format output.
